...
{ #Begin function
  ...
  Vc   <- 0    + data$Dependency*DepenC + data$WeaCon*RainC
  
  Vm   <- Cm   + data$Lao*LaoM + Male*MaleM*data$Lao   + data$HJob*HJobM  +  data$Age6*Age60M  +
                 data$HEdu*HEduM  + data$ChLug*LugM  + data$Accom*AccomM + data$Tpp*BusiTripM +   
                 data$Dependency*DepenM + data$Hcar*HcarM #+ data$Inc*HIncM  
  
  Vt   <- Ct   + data$Lao*LaoT + Male*MaleT*data$Lao +  + data$HJob*HJobT   +  data$Age6*Age60T +
                 data$HEdu*HEduT + data$ChLug*LugT  + data$Accom*AccomT + data$Tpp*BusiTripT +                          
                 0 + data$Hcar*HcarT  + data$WeaCon*RainT+ data$Dependency*DepenT # + data$Inc*HIncT 
  
  Vb   <- Cb   + data$Lao*LaoB + Male*MaleB*data$Lao  + data$HJob*HJobB   +  data$Age6*Age60B +
                 data$HEdu*HEduB + data$ChLug*LugB  + data$Accom*AccomB + data$Tpp*BusiTripB +
                 0 + data$Hcar*HcarB  + data$WeaCon*RainB  #+ data$Inc*HIncB
  
  Vv   <- Cv   + data$Lao*LaoV + Male*MaleV*data$Lao  + data$HJob*HJobV   +  data$Age6*Age60V  +
                 data$HEdu*HEduV  + data$ChLug*LugV  + data$Accom*AccomV + data$Tpp*BusiTripV + 
                 0 + data$WeaCon*RainV   + data$Hcar*HcarV + data$Dependency*DepenV #  + data$Inc*HIncV                                                       
