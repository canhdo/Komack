...
{ #Begin function
  ...
  Vm   <- Cm   + data$TCost_MT*Cost +   data$ParkFee_MT*Parking + #
                 data$Vehtime_MT*Vehtime    #+ data$Safe_MT*Safety   #+ data$ParkFee_MT*Parking
  
  Vc   <- 0    + data$TCost_Car*Cost +  data$ParkFee_Car*Parking + 
                 data$Vehtime_Car*Vehtime #+ data$Delay_Car*Delay #+ data$Safe_Car*Safety    #+ data$Delay_Car*Delay #+ data$ParkFee_Car*Parking
  
  Vt   <- Ct   + data$TCost_Taxi*Cost  + 
                 data$Vehtime_Taxi*Vehtime  #   + 
                 #data$Safe_Taxi*Safety     #+ 
                 #data$Delay_Taxi*Delay
  
  Vb   <- Cb   + data$TCost_Bus*Cost + # + 
                  data$Vehtime_Bus*Vehtime + #+ data$Delay_Bus*Delay # + data$Safe_Bus*Safety     #+ data$Wtime_Bus*Waiting #+ data$Accesstime_Bus*Access #+ data$Delay_Car*Delay #+ 
                  data$NoTranfer_Bus*Transfer
  
  Vv   <- Cv   + data$TCost_VCAT*Cost #+ 
                 data$Vehtime_VCAT*Vehtime +   #    + data$Safe_VCAT*Safety    #+ data$Wtime_VCAT*Waiting  #+ data$Accesstime_VCAT*Access     
