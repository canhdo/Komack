...
{ #Begin function
  ...
  Vm   <- Cm   + data$TCost_MT*Cost  + data$ParkFee_MT*Parking + data$Vehtime_MT*Vehtime   # + data$Safe_MT*Safety
  
  Vc   <- 0    + data$TCost_Car*Cost + data$ParkFee_Car*Parking + data$Vehtime_Car*Vehtime  #+ data$Safe_Car*Safety    #+ data$Delay_Car*Delay 
  
  Vt   <- Ct   + data$TCost_Taxi*Cost + data$VehCost_Taxi*Vehtime   # + data$Safe_Taxi*Safety     #+ data$Delay_Car*Delay
  
  Vb   <- Cb   + data$TCost_Bus*Cost  + data$Vehtime_Bus*Vehtime + data$NoTranfer_Bus*Transfer  #+ data$Safe_Bus*Safety     #+ data$Wtime_Bus*Waiting #+ data$Accesstime_Bus*Access #+ data$Delay_Car*Delay 
  
  Vv   <- Cv   + data$TCost_VCAT*Cost + data$Vehtime_VCAT*Vehtime + data$NoTranfer_VCAT*Transfer    #+ data$Safe_VCAT*Safety    #+ data$Wtime_VCAT*Waiting  #+ data$Accesstime_VCAT*Access                                                      
